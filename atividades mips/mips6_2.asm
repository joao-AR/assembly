.data
	vetor: .space 400
	buffer: .space 100
	caminhoArquivo: .asciiz "dados2.txt" 
...
.text
	main:
		...
		addi $a1, $zero, 0 #  0 for read-only, 1 for write-only with create, and 9 for write-only with create and append.
